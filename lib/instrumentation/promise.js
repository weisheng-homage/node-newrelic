...
module.exports = function initialize(agent, library, spec) {
  ...
  function wrappedPromise(executor) {
    ...
    // const { segment: parent } = contextManager.getContext()
    ...
    if (
      ...
      try {
        ...
        const segmentContext = segment
        contextManager.runWithContext(segmentContext, () => {
          //const ctext = contextManager.getContext()
          // Must run after promise is defined so that `__NR_wrapper` can be set.
