...
const ENV_MAPPING = {
  ...
  instrumentation: {
    aws_sdk: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_AWS_SDK_ENABLED'
    },
    amqplib: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_AMPQLIB_ENABLED'
    },
    cassandra_driver: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_CASSANDRA_DRIVER_ENABLED'
    },
    connect: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_CONNECT_ENABLED'
    },
    bluebird: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_BLUEBIRD_ENABLED'
    },
    director: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_DIRECTOR_ENABLED'
    },
    express: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_EXPRESS_ENABLED'
    },
    generic_pool: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_GENERIC_POOL_ENABLED'
    },
    hapi_hapi: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_HAPI_HAPI_ENABLED'
    },
    hapi: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_HAPI_ENABLED'
    },
    ioredis: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_IOREDIS_ENABLED'
    },
    koa: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_KOA_ENABLED'
    },
    memcached: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_MEMCACHED_ENABLED'
    },
    mongodb: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_MONGODB_ENABLED'
    },
    mysql: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_MYSQL_ENABLED'
    },
    pg: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_PG_ENABLED'
    },
    q: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_Q_ENABLED'
    },
    redis: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_REDIS_ENABLED'
    },
    restify: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_RESTIFY_ENABLED'
    },
    superagent: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_SUPERAGENT_ENABLED'
    },
    oracle: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_ORACLE_ENABLED'
    },
    vision: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_VISION_ENABLED'
    },
    when: {
      enabled: 'NEW_RELIC_INSTRUMENTATION_WHEN_ENABLED'
    }
  }
}
...
const BOOLEAN_VARS = new Set([
  ...
  'NEW_RELIC_INSTRUMENTATION_AWS_SDK_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_AMPQLIB_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_CASSANDRA_DRIVER_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_CONNECT_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_BLUEBIRD_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_DIRECTOR_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_EXPRESS_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_GENERIC_POOL_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_HAPI_HAPI_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_HAPI_ENABLED',
  ...
  'NEW_RELIC_INSTRUMENTATION_SUPERAGENT_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_ORACLE_ENABLED',
  'NEW_RELIC_INSTRUMENTATION_VISION_ENABLED',
