...
exports.config = () => ({
  ...
  /**
   * Allows individual pieces of instrumentation to be disabled.
   * WARNING: disabling some pieces of instrumentation can result in
   * transaction state loss resulting in the loss of data for more than
   * just the module desired.
   */
  instrumentation: {
